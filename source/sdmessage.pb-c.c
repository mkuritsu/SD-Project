...
{
  {
    ...
    0,   /* quantifier_offset */
    offsetof(StatisticsT, num_operations),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  ...
  },
  {
    ...
    0,   /* quantifier_offset */
    offsetof(StatisticsT, execution_time),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned statistics_t__field_indices_by_name[] = {
  1,   /* field[1] = clients_connected */
  2,   /* field[2] = execution_time */
  0,   /* field[0] = num_operations */
};
